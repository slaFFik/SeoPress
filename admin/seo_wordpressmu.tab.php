...
function sp_admin_wpmu_tab(){
    ...
    $html .= sp_admin_tab_header( 
                __('Wordpress Network Blogs', 'seopress'),
                __( 'Setup your title and meta tags of your Wordpress main blog.', 'seopress'), 
                $seopress_plugin_url . 'includes/images/logo-wordpress.png' );
    ...
    foreach( $sections AS $section ){
        $accordion->add_section( 
                        $section['type'], 
                        $section['title'], 
                        sp_type_box( $section['type'] ), 
                        isset($section['extra_title'])?$section['extra_title']:''
                    );
    }
