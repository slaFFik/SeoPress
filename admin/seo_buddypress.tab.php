...
function sp_admin_bp_tab(){
    ...
    $html .= sp_admin_tab_header(
                __( 'BuddyPress', 'seopress'),
                __( 'Setup your title and meta tags of the buddypress pages.', 'seopress'),
                $seopress_plugin_url . 'includes/images/logo-buddypress.png' );
    ...
    foreach ( (array) $bp as $key => $value ) {
        if( isset($bp->$key) && isset($bp->$key->slug) && $bp->$key->slug != '' )
